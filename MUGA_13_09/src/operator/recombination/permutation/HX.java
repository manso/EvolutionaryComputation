 ...
 * @author ZULU
 */
public class HX extends CrossoverPRM {
    ...
    public void doCrossover(PRM_Individual i1, PRM_Individual i2) {
        ...
        int[][] offspring = executeHX(g1, g2, i1.getNumCopies() + i2.getNumCopies());
    ...
    private static int[] HX(int[] parent1, int[] parent2) {
        ...
        while (children.size() < length) {
            ...
            if (random.nextBoolean()) {
               //random p1 p2
                c = selectNextCity(parent1, parent2, children, c);
            } else {
               //random p2-p1 
                c = selectNextCity(parent2, parent1, children, c);
            }
            
            if (c == -1) {
                //select random
                c = selectRandom(children, length);
            }
            children.add(c);
        }
        //-------------------------- Return array ----
    ...
    public static void main(String[] args) {
        ...
        int[][] o = executeHX(i1.getGeneValues(), i2.getGeneValues(), 20);
