 ...
 * @author ZULU
 */
public class LimitedOPT2 extends MutationPRM {
...
//        str.append(" x x G2 x G1 x \n");
    ...
    public static void LS_2_opt(int[] genome, double probability) {
        int limit = (int)Math.min(genome.length, 10)  ;
        for (int p1 = 0; p1 < genome.length; p1++) {
            if (Math.random() < probability) {
                for (int p2 = p1-limit; p2 < p1+limit; p2++) {
