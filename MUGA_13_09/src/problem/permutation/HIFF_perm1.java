 ...
 * @author ZULU
 */
public class HIFF_perm1 extends PRM_Individual {
...
//        Console.println("GENOME \t" + Arrays.toString(genome));
    ...
    public String getHIFF() {
        ...
        StringBuilder order = new StringBuilder(bits.toString());
        for (int i = 0; i < bitOrder.length; i++) {
            order.setCharAt(bitOrder[i], bits.charAt(i));
        }
...
//        shuffleOrder();
     ...
     */
    @Override
    public HIFF_perm1 getClone() {
        //make new individuals
        HIFF_perm1 ind = new HIFF_perm1();
    ...
    public static void main(String[] args) {
        HIFF_perm1 h = new HIFF_perm1();
        h.evaluate();
        MWM_perm mut = new MWM_perm();

        for (int i = 1; i < 10; i++) {
            HIFF_perm1 h1 = (HIFF_perm1) h.getClone();
            h1.setNumCopys(i);
