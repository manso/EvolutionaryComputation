 ...
 * @author ZULU
 */
public class HIFF_shuffle_perm extends HIFF_K {
...
//        }
    ...
    public HIFF_shuffle_perm() {
    }

    public HIFF_shuffle_perm(String bits, int k_ary) {
        super(bits);
...
//        System.out.println("XBIT " + txt);
    ...
    public static void main(String[] args) {
        HIFF_shuffle_perm h = new HIFF_shuffle_perm("00011111", 2);
        h.evaluate();
