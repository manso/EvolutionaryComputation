 ...
 * @author ZULU
 */
public class F3Deceptive extends Individual {
    ...
    public F3Deceptive() {
        ...
        for (int i = 0; i < NUMBER_OF_BLOCKS; i++) {
            addGene(new GeneBinary(GENE_SIZE));
        }
    }
    ...
    public String getGenomeInformation() {
        ...
        buf.append("Deceptive Problem <").append(NUMBER_OF_BLOCKS).append(">");
        buf.append("\n\n 3-bit deceptive problem");
        buf.append("\n0.9 if u = 0");
        buf.append("\n0.8 if u = 1");
        buf.append("\n0   if u = 2");
        buf.append("\n1   if u = 3");
    ...
    protected double getGeneDeceptiveValue(int gene) {
        return values[genome.getGene(gene).getAlels().getNumberOfOnes()];
    }
